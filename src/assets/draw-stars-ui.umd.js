(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["draw-stars-ui"] = factory();
	else
		root["draw-stars-ui"] = factory();
...
var isCallable = __webpack_require__(5080);

var tryToString = __webpack_require__(5288);
...
var isObject = __webpack_require__(6661);
...
var toIndexedObject = __webpack_require__(6114);

var toAbsoluteIndex = __webpack_require__(6060);

var lengthOfArrayLike = __webpack_require__(8935); // `Array.prototype.{ indexOf, includes }` methods implementation
...
var DESCRIPTORS = __webpack_require__(999);

var isArray = __webpack_require__(9666);
...
var uncurryThisRaw = __webpack_require__(5445);
...
var hasOwn = __webpack_require__(967);

var ownKeys = __webpack_require__(6589);

var getOwnPropertyDescriptorModule = __webpack_require__(4365);

var definePropertyModule = __webpack_require__(9091);
...
var createPropertyDescriptor = __webpack_require__(4608);
...
var makeBuiltIn = __webpack_require__(1535);

var defineGlobalProperty = __webpack_require__(758);
...
var global = __webpack_require__(6852); // eslint-disable-next-line es/no-object-defineproperty -- safe
...
var fails = __webpack_require__(8153); // Detect IE8's incomplete defineProperty implementation
...
var global = __webpack_require__(6852);
...
var getBuiltIn = __webpack_require__(5908);
...
var userAgent = __webpack_require__(2528);
...
var getOwnPropertyDescriptor = (__webpack_require__(4365).f);

var createNonEnumerableProperty = __webpack_require__(7442);

var defineBuiltIn = __webpack_require__(4466);

var defineGlobalProperty = __webpack_require__(758);

var copyConstructorProperties = __webpack_require__(996);

var isForced = __webpack_require__(5368);
/*
...
var fails = __webpack_require__(8153);
...
var NATIVE_BIND = __webpack_require__(5833);
...
var classofRaw = __webpack_require__(1198);
...
var aCallable = __webpack_require__(7854);

var isNullOrUndefined = __webpack_require__(2259); // `GetMethod` abstract operation
...
var toObject = __webpack_require__(9401);
...
var createElement = __webpack_require__(8605); // Thanks to IE8 for its funny defineProperty
...
var store = __webpack_require__(4066);
...
var NATIVE_WEAK_MAP = __webpack_require__(1394);
...
var shared = __webpack_require__(4066);

var sharedKey = __webpack_require__(5321);

var hiddenKeys = __webpack_require__(5758);
...
var classof = __webpack_require__(1198); // `IsArray` abstract operation
...
var $documentAll = __webpack_require__(3279);
...
var isPrototypeOf = __webpack_require__(8617);

var USE_SYMBOL_AS_UID = __webpack_require__(8678);
...
var toLength = __webpack_require__(9888); // `LengthOfArrayLike` abstract operation
...
var CONFIGURABLE_FUNCTION_NAME = (__webpack_require__(2733).CONFIGURABLE);

var inspectSource = __webpack_require__(7385);

var InternalStateModule = __webpack_require__(8411);
...
var IE8_DOM_DEFINE = __webpack_require__(6357);

var V8_PROTOTYPE_DEFINE_BUG = __webpack_require__(6503);

var anObject = __webpack_require__(249);

var toPropertyKey = __webpack_require__(9272);
...
var call = __webpack_require__(2362);

var propertyIsEnumerableModule = __webpack_require__(7117);
...
var IE8_DOM_DEFINE = __webpack_require__(6357); // eslint-disable-next-line es/no-object-getownpropertydescriptor -- safe
...
var internalObjectKeys = __webpack_require__(6990);

var enumBugKeys = __webpack_require__(4845);
...
var indexOf = (__webpack_require__(4815).indexOf);
...
var getOwnPropertyNamesModule = __webpack_require__(6140);

var getOwnPropertySymbolsModule = __webpack_require__(2413);
...
var isNullOrUndefined = __webpack_require__(2259);
...
var uid = __webpack_require__(3728);
...
var IS_PURE = __webpack_require__(5331);
...
var V8_VERSION = __webpack_require__(1755);

var fails = __webpack_require__(8153); // eslint-disable-next-line es/no-object-getownpropertysymbols -- required for testing
...
var toIntegerOrInfinity = __webpack_require__(5467);
...
var requireObjectCoercible = __webpack_require__(4658);
...
var trunc = __webpack_require__(6538); // `ToIntegerOrInfinity` abstract operation
...
var isSymbol = __webpack_require__(7694);

var getMethod = __webpack_require__(7641);

var ordinaryToPrimitive = __webpack_require__(3745);

var wellKnownSymbol = __webpack_require__(8174);
...
var toPrimitive = __webpack_require__(1521);

var isSymbol = __webpack_require__(7694); // `ToPropertyKey` abstract operation
...
/* eslint-disable es/no-symbol -- required for testing */
var NATIVE_SYMBOL = __webpack_require__(3676);
...
var fails = __webpack_require__(8153); // V8 ~ Chrome 36-
...
var $ = __webpack_require__(2336);

var toObject = __webpack_require__(9401);

var lengthOfArrayLike = __webpack_require__(8935);

var setArrayLength = __webpack_require__(639);

var doesNotExceedSafeInteger = __webpack_require__(2628);
...
var deletePropertyOrThrow = __webpack_require__(4264);

var doesNotExceedSafeInteger = __webpack_require__(2628); // IE8-
  ...
  var Parser = function Parser(context, imports, fileInfo) {
    ...
    return {
      ...
      parse: function (str, callback, additionalData) {
        ...
        var modifyVars;
        var ignored;
        var preText = ''; // Optionally disable @plugin parsing
...
// EXTERNAL MODULE: ./node_modules/_less@4.1.3@less/dist/less.js
var less = __webpack_require__(667);
;// CONCATENATED MODULE: ./node_modules/_thread-loader@3.0.4@thread-loader/dist/cjs.js!./node_modules/_babel-loader@8.2.5@babel-loader/lib/index.js??clonedRuleSet-82.use[1]!./node_modules/_vue-loader@15.10.0@vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!./node_modules/_vue-loader@15.10.0@vue-loader/lib/index.js??vue-loader-options!./packages/flop.vue?vue&type=template&id=0248acc4&scoped=true&
var render = function render() {
  var _vm = this,
      _c = _vm._self._c;

  return _c('div', {
    staticClass: "count-flop"
  }, _vm._l(_vm.value, function (item, index) {
    return _c('div', {
      key: index,
      class: item !== '.' ? 'count-flop-box' : 'count-flop-point'
    }, [item != '.' ? _c('div', {
      staticClass: "count-flop-content",
      class: ['rolling_' + item]
    }, _vm._l(_vm.numberList, function (num, numIndex) {
      return _c('div', {
        key: numIndex,
        staticClass: "count-flop-num"
      }, [_vm._v(" " + _vm._s(num) + " ")]);
    }), 0) : _c('div', {
      staticClass: "count-flop-content"
    }, [_vm._v(".")])]);
...
;// CONCATENATED MODULE: ./node_modules/_thread-loader@3.0.4@thread-loader/dist/cjs.js!./node_modules/_babel-loader@8.2.5@babel-loader/lib/index.js??clonedRuleSet-82.use[1]!./node_modules/_vue-loader@15.10.0@vue-loader/lib/index.js??vue-loader-options!./packages/flop.vue?vue&type=script&lang=js&
/* harmony default export */ var flopvue_type_script_lang_js_ = ({
  name: "Flop",
  props: {
    // 最大值
    maxVal: {
  ...
  watch: {
    val(newVal) {
      ...
      this.value = newVal.toString().split("");
    }
...
;// CONCATENATED MODULE: ./packages/flop.vue?vue&type=script&lang=js&
 /* harmony default export */ var packages_flopvue_type_script_lang_js_ = (flopvue_type_script_lang_js_); 
;// CONCATENATED MODULE: ./node_modules/_mini-css-extract-plugin@2.6.1@mini-css-extract-plugin/dist/loader.js??clonedRuleSet-74.use[0]!./node_modules/_css-loader@6.7.1@css-loader/dist/cjs.js??clonedRuleSet-74.use[1]!./node_modules/_vue-loader@15.10.0@vue-loader/lib/loaders/stylePostLoader.js!./node_modules/_postcss-loader@6.2.1@postcss-loader/dist/cjs.js??clonedRuleSet-74.use[2]!./node_modules/_less-loader@6.2.0@less-loader/dist/cjs.js??clonedRuleSet-74.use[3]!./node_modules/_vue-loader@15.10.0@vue-loader/lib/index.js??vue-loader-options!./packages/flop.vue?vue&type=style&index=0&id=0248acc4&prod&lang=less&scoped=true&
// extracted by mini-css-extract-plugin

;// CONCATENATED MODULE: ./packages/flop.vue?vue&type=style&index=0&id=0248acc4&prod&lang=less&scoped=true&
...
;// CONCATENATED MODULE: ./packages/flop.vue
...
var component = normalizeComponent(
  packages_flopvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var flop = (component.exports);
...
const components = [flop]; // 定义install方法
...
//# sourceMappingURL=draw-stars-ui.umd.js.map